...
from app.routes import auth_routes as auth, course_routes as courses, quiz_progress_routes as quiz_progress, quiz_routes as quizzes, feedback_routes as feedback, metrics_routes as metrics
